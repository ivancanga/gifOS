...
function uploadGif(gif) {
    fetch('https://upload.giphy.com/v1/gifs?api_key=xBWsI1LWcGLChS6L9d5ucODsG0BfkNEx', {
        method: 'POST',
        body: gif,
    })
        .then(response => {
        ...
        .then(data => {
            ...
            fetch(`https://api.giphy.com/v1/gifs/${data.data.id}?&api_key=xBWsI1LWcGLChS6L9d5ucODsG0BfkNEx`)
                .then(response => {
                    return response.json();
                })
                .then(data => {
